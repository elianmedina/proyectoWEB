        ...
        <>
            ...
            <div id='tiendas'>
                <div>
                    ...
                    <h2 id="textodescriptivo99">Una franquicia de restaurantes de comida rápida estadounidense. Sus principales productos son las hamburguesas, las patatas fritas, los menús para el desayuno y los refrescos.</h2>
                    <Link to='/Menu'>
                ...
                <div>
                    ...
                    <h2 id="textodescriptivo88">Es una cadena de restaurantes de comida rápida estadounidense especializada en pollo frito. También piezas de pollo crujientes que se preparan mediante un proceso de fritura a presión.</h2>
                   <Link to='/Menu'>
                ...
                <div>
                    ...
                    <h2 id="textodescriptivo77"> Cadena de restaurantes colombiana especializada en el pollo frito.
</h2>
                   <Link to='/Menu'>
